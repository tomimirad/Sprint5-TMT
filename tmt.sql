...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-05-2023 a las 15:21:19
...
(2, 'Silla gamer', 50, 'a', 'product-img-1683679138134.jpg', 1, 3, 1, 'null'),
(3, 'Mesa Comedor Estilo Nordico', 15675, 'Mesa comedor 120 cm x 70 cm estilo nordico.', 'mesaG.jpg', 20, 3, 1, 'null'),
(4, 'Mesa De Luz Madrid 1', 9489, 'MESA DE LUZ MODERNA CON ESTANTE 1 CAJON DORMITORIO CENTRO ESTANT Lo primero que verás al abrir los ojos va a ser esta moderna y práctica mesa de luz que hará de tu dormitorio el lugar que siempre soñaste.Colores disponibles: Blanco, Wengue', 'mesaLuz.jpg', 10, 3, 1, 'null'),
...
(10, 'Escritorio Industrial 12', 20076, 'Escritorio Industrial C/ estantes laterales (2).', 'EscritorioEstructuraMetal.jpg', 20, 3, 8, 'null'),
...
(13, 'Sillon de 3 cuerpos esquinero', 149990, 'CARACTERISTICAS GENERALES Material: Chenille Material, Patas: Metal, Tipo: Sillon 3 Cuerpos, Modelo: Esquinero. DIMENSIONES Alto: 76 Cm, Ancho: 185 Cm, Profundidad: 75 Cm.', 'SillonEsquinero3Cuerpos.jpg', 25, 6, 4, 'null'),
...
INSERT INTO `subcategoria` (`subCategoria_id`, `subCategoria`, `categoria_id`) VALUES
(1, 'Mesa', 1),
(2, 'Cama', 1),
(3, 'Escritorio', 1),
(4, 'Sillon', 1),
...
--
ALTER TABLE `productos`
  ADD CONSTRAINT `FK_7f0b03f1-dc78-4eeb-ad3e-d4897c03d6be` FOREIGN KEY (`subCategoria_id`) REFERENCES `subcategoria` (`subCategoria_id`);
